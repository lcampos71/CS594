package com.example.campos_luis.myflickr;
...
//import com.detroitteatscdime.myflickr.R;
    ...
    private class LoadPhotos extends AsyncTask<String, Long, Long> {
        ...
        protected Long doInBackground(String... strings) {
            String dataString = "https://api.flickr.com/services/rest/" +
                    "?method=flickr.photos.search&api_key="+ com.example.campos_luis.myflickr.Constants.API_KEY+"&min_upload_date=04%2F25%2F2015&lat="+ com.example.campos_luis.myflickr.Constants.LATITUDE+"&lon=" +
                    com.example.campos_luis.myflickr.Constants.LONGITUDE+"&radius="+ com.example.campos_luis.myflickr.Constants.RADIUS+"&radius_units=km&format=json&nojsoncallback=1";
...
//                   Constants.API_KEY + "&per_page=" + Constants.NUM_PHOTOS + "&format=json&nojsoncallback=1";
            Log.i(com.example.campos_luis.myflickr.Constants.TAG, dataString);
            try {
                ...
                if (status == 200) {
                    ...
                    Log.d(com.example.campos_luis.myflickr.Constants.TAG, photoData);
                ...
                Log.i(com.example.campos_luis.myflickr.Constants.TAG, "Malformed Url");
                e.printStackTrace();
                return 1l;
            } catch (IOException e) {
                e.printStackTrace();
